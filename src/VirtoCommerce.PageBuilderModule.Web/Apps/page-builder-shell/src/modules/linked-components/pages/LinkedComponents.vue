          ...
          >
            ...
            <div class="tw-min-w-0 tw-flex-1">
              <div class="tw-font-semibold">
                {{ $t("LINKED_COMPONENTS.NOTIFICATIONS.ERROR_GENERIC") }}
              </div>
            ...
            <VcButton
              ...
              @click="handleRetry"
            >
              {{ $t("LINKED_COMPONENTS.TOOLBAR.REFRESH") }}
            </VcButton>
          </div>
...
import { LinkedComponentDetails, LinkedComponentsTable, RenameLinkedComponentPopup } from "../components";
...
const bladeToolbar = ref<IBladeToolbar[]>([
  {
    id: "refresh",
    title: computed(() => t("LINKED_COMPONENTS.TOOLBAR.REFRESH")),
    icon: "lucide-refresh-cw",
