...
export class AssetEntry implements IAssetEntry {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tenant = _data["tenant"] ? TenantIdentity.fromJS(_data["tenant"]) : undefined as any;
            this.blobInfo = _data["blobInfo"] ? BlobInfo.fromJS(_data["blobInfo"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["blobInfo"] = this.blobInfo ? this.blobInfo.toJSON() : undefined as any;
...
export class TenantIdentity implements ITenantIdentity {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.type = _data["type"];
            (this as any).isEmpty = _data["isEmpty"];
            (this as any).isValid = _data["isValid"];
        }
    }
