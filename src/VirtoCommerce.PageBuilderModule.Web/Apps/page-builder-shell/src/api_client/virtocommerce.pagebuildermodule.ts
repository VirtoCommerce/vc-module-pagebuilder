...
export class PageBuilderAssetsClient extends AuthApiBase {
    ...
    protected processSearchReferences(response: Response): Promise<PageBuilderAssetReferencesSearchResult> {
        ...
        if (status === 200) {
            ...
            result200 = PageBuilderAssetReferencesSearchResult.fromJS(resultData200);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
...
export class PageBuilderAssetReference implements IPageBuilderAssetReference {
    assetUrl?: string | undefined;
    normalizedAssetUrl?: string | undefined;
    referencesCount?: number;
    pages?: PageBuilderAssetReferencePage[] | undefined;

    constructor(data?: IPageBuilderAssetReference) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.assetUrl = _data["assetUrl"];
            this.normalizedAssetUrl = _data["normalizedAssetUrl"];
            this.referencesCount = _data["referencesCount"];
            if (Array.isArray(_data["pages"])) {
                this.pages = [] as any;
                for (let item of _data["pages"])
                    this.pages!.push(PageBuilderAssetReferencePage.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PageBuilderAssetReference {
        data = typeof data === 'object' ? data : {};
        let result = new PageBuilderAssetReference();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["normalizedAssetUrl"] = this.normalizedAssetUrl;
        data["referencesCount"] = this.referencesCount;
        if (Array.isArray(this.pages)) {
            data["pages"] = [];
            for (let item of this.pages)
                data["pages"].push(item ? item.toJSON() : undefined as any);
...
export interface IPageBuilderAssetReference {
    assetUrl?: string | undefined;
    normalizedAssetUrl?: string | undefined;
    referencesCount?: number;
    pages?: PageBuilderAssetReferencePage[] | undefined;
...
export class PageBuilderAssetReferencePage implements IPageBuilderAssetReferencePage {
    id?: string | undefined;
    name?: string | undefined;
    permalink?: string | undefined;
    cultureName?: string | undefined;
    ...
    constructor(data?: IPageBuilderAssetReferencePage) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): PageBuilderAssetReferencePage {
        data = typeof data === 'object' ? data : {};
        let result = new PageBuilderAssetReferencePage();
        result.init(data);
        return result;
    }
...
export interface IPageBuilderAssetReferencePage {
    id?: string | undefined;
    name?: string | undefined;
    permalink?: string | undefined;
    cultureName?: string | undefined;
...
export class PageBuilderAssetReferencesSearchCriteria implements IPageBuilderAssetReferencesSearchCriteria {
    storeId?: string | undefined;
    ...
    constructor(data?: IPageBuilderAssetReferencesSearchCriteria) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.includePages = _data["includePages"];
    ...
    static fromJS(data: any): PageBuilderAssetReferencesSearchCriteria {
        data = typeof data === 'object' ? data : {};
        let result = new PageBuilderAssetReferencesSearchCriteria();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["includePages"] = this.includePages;
...
export interface IPageBuilderAssetReferencesSearchCriteria {
    storeId?: string | undefined;
    statuses?: string | undefined;
    includePages?: boolean;
    assetUrls?: string[] | undefined;
...
export class PageBuilderAssetReferencesSearchResult implements IPageBuilderAssetReferencesSearchResult {
    totalCount?: number;
    results?: PageBuilderAssetReference[] | undefined;

    constructor(data?: IPageBuilderAssetReferencesSearchResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(PageBuilderAssetReference.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PageBuilderAssetReferencesSearchResult {
        data = typeof data === 'object' ? data : {};
        let result = new PageBuilderAssetReferencesSearchResult();
        result.init(data);
        return result;
    }
...
export interface IPageBuilderAssetReferencesSearchResult {
    totalCount?: number;
    results?: PageBuilderAssetReference[] | undefined;
}
...
export class PageBuilderPageSearchCriteria implements IPageBuilderPageSearchCriteria {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.activeOn = _data["activeOn"] ? new Date(_data["activeOn"].toString()) : undefined as any;
            this.modifiedSince = _data["modifiedSince"] ? new Date(_data["modifiedSince"].toString()) : undefined as any;
            this.modifiedBefore = _data["modifiedBefore"] ? new Date(_data["modifiedBefore"].toString()) : undefined as any;
            this.responseGroup = _data["responseGroup"];
            this.objectType = _data["objectType"];
            if (Array.isArray(_data["objectTypes"])) {
                this.objectTypes = [] as any;
    ...
    toJSON(data?: any) {
        ...
        data["activeOn"] = this.activeOn ? this.activeOn.toISOString() : undefined as any;
        data["modifiedSince"] = this.modifiedSince ? this.modifiedSince.toISOString() : undefined as any;
        data["modifiedBefore"] = this.modifiedBefore ? this.modifiedBefore.toISOString() : undefined as any;
        data["responseGroup"] = this.responseGroup;
        data["objectType"] = this.objectType;
        if (Array.isArray(this.objectTypes)) {
            data["objectTypes"] = [];
