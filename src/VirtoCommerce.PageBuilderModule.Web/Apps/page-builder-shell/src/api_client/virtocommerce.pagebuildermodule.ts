...
export class PageBuilderClient extends AuthApiBase {
     ...
     * @return OK
     */
    getTemplate(storeId?: string | undefined, theme?: string | undefined, path?: string | undefined, type?: string | undefined, draft?: boolean | undefined, ref?: string | undefined): Promise<void> {
        ...
        if (ref === null)
            throw new globalThis.Error("The parameter 'ref' cannot be null.");
     ...
     * @return OK
     */
    gitPublish(storeId?: string | undefined, path?: string | undefined, type?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/pagebuilder/git/publish?";
        if (storeId === null)
            throw new globalThis.Error("The parameter 'storeId' cannot be null.");
        else if (storeId !== undefined)
            url_ += "storeId=" + encodeURIComponent("" + storeId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGitPublish(_response);
        });
    }

    protected processGitPublish(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    gitUnpublish(storeId?: string | undefined, path?: string | undefined, type?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/pagebuilder/git/unpublish?";
        if (storeId === null)
            throw new globalThis.Error("The parameter 'storeId' cannot be null.");
        else if (storeId !== undefined)
            url_ += "storeId=" + encodeURIComponent("" + storeId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGitUnpublish(_response);
        });
    }

    protected processGitUnpublish(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    gitPublishStatus(storeId?: string | undefined, path?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/pagebuilder/git/publish-status?";
        if (storeId === null)
            throw new globalThis.Error("The parameter 'storeId' cannot be null.");
        else if (storeId !== undefined)
            url_ += "storeId=" + encodeURIComponent("" + storeId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGitPublishStatus(_response);
        });
    }

    protected processGitPublishStatus(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    gitPreview(storeId?: string | undefined, path?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/pagebuilder/git/preview?";
        if (storeId === null)
            throw new globalThis.Error("The parameter 'storeId' cannot be null.");
        else if (storeId !== undefined)
            url_ += "storeId=" + encodeURIComponent("" + storeId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGitPreview(_response);
        });
    }

    protected processGitPreview(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    gitDiscardDraft(storeId?: string | undefined, path?: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/pagebuilder/git/discard-draft?";
        if (storeId === null)
            throw new globalThis.Error("The parameter 'storeId' cannot be null.");
        else if (storeId !== undefined)
            url_ += "storeId=" + encodeURIComponent("" + storeId) + "&";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGitDiscardDraft(_response);
        });
    }

    protected processGitDiscardDraft(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class PageBuilderSharedComponentsClient extends AuthApiBase {
    ...
    protected processGetContent(response: Response): Promise<any> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    saveContentPUT(id: string, body?: any | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSaveContentPUT(_response);
        });
    }

    protected processSaveContentPUT(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
    ...
    saveContentPOST(id: string, body?: any | undefined): Promise<void> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSaveContentPOST(_response);
        });
    }

    protected processSaveContentPOST(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
