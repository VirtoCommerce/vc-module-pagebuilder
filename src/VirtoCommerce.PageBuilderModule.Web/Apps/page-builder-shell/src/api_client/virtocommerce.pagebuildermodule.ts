...
export class PageBuilderClient extends AuthApiBase {
  ...
  getTemplate(
    ...
    if (theme === null) throw new globalThis.Error("The parameter 'theme' cannot be null.");
    else if (theme !== undefined) url_ += "theme=" + encodeURIComponent("" + theme) + "&";
    if (path === null) throw new globalThis.Error("The parameter 'path' cannot be null.");
    ...
    if (draft === null) throw new globalThis.Error("The parameter 'draft' cannot be null.");
    else if (draft !== undefined) url_ += "draft=" + encodeURIComponent("" + draft) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  search(
    ...
    if (folder === null) throw new globalThis.Error("The parameter 'folder' cannot be null.");
    else if (folder !== undefined) url_ += "folder=" + encodeURIComponent("" + folder) + "&";
    if (pattern === null) throw new globalThis.Error("The parameter 'pattern' cannot be null.");
    else if (pattern !== undefined) url_ += "pattern=" + encodeURIComponent("" + pattern) + "&";
...
export class PageBuilderPageClient extends AuthApiBase {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as GroupedPageBuilderPageSearchResult);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  protected processGetGroup(response: Response): Promise<GroupedPageBuilderPage> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as GroupedPageBuilderPage);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
  ...
  publishGroup(groupId: string, publish?: boolean | undefined): Promise<void> {
    ...
    if (groupId === undefined || groupId === null)
      throw new globalThis.Error("The parameter 'groupId' must be defined.");
    url_ = url_.replace("{groupId}", encodeURIComponent("" + groupId));
    if (publish === null) throw new globalThis.Error("The parameter 'publish' cannot be null.");
    else if (publish !== undefined) url_ += "publish=" + encodeURIComponent("" + publish) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processPublishStatus(response: Response): Promise<FilePublishStatus> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        result200 =
          _responseText === "" ? null : (JSON.parse(_responseText, this.jsonParseReviver) as FilePublishStatus);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
