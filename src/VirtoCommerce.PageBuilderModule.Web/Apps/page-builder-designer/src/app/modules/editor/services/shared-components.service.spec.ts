...
describe('SharedComponentsService', () => {
    ...
    it('searches in the active store', () => {
        ...
        const request = http.expectOne('/api/page-builder-shared-components/search');
    ...
    it('creates metadata and content together', () => {
        ...
        const request = http.expectOne('/api/page-builder-shared-components');
        expect(request.request.method).toBe('POST');
    ...
    it('loads and updates raw component content', () => {
        ...
        let request = http.expectOne('/api/page-builder-shared-components/component%2F1/content');
        expect(request.request.method).toBe('GET');
        request.flush(content);

        service.updateContent('component/1', content).subscribe();
        request = http.expectOne('/api/page-builder-shared-components/component%2F1/content');
