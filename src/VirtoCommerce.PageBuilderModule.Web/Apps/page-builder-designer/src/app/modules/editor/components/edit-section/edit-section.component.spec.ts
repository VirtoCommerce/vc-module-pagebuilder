      ...
      providers: [
        provideMockStore({
          selectors: [
            ...
            { selector: selectors.selectLinkedComponentInstanceFromRoute, value: null },
            {
              selector: selectors.selectCurrentLinkedComponent,
        ...
        }),
        {
          provide: AppConfig,
          useValue: {
            getValue: vi.fn((option: string) => option === 'canInsertLinkedComponents' || canEdit),
          },
        },
