...
import { LinkedComponentsLibraryComponent } from '@editor/controls/linked-components-library/linked-components-library.component';
...
@Component({
    ...
    imports: [KeyValuePipe, OverlapPanelComponent, PanelComponent, IconComponent, AddSectionGroupComponent, AddSectionItemComponent, LinkedComponentsLibraryComponent]
})
export class AddSectionComponent {
    ...
    readonly isReadOnly = computed(() =>
        !!this.viewModel()?.isLinkedDocument && !canEditLinkedComponentOriginal(this.appConfig));
    ...
    applySectionsFilter(event: Event) {
        ...
        this.store.dispatch(actions.searchLinkedComponents({ keyword: value }));
    }
}
