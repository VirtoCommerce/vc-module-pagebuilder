...
import {ChangeDetectionStrategy, Component, InputSignal, ViewEncapsulation} from '@angular/core';
...
export interface MatDateRangePickerInput<D> extends MatDatepickerControl<D> {
    comparisonStart: InputSignal<D | null>;
    comparisonEnd: InputSignal<D | null>;
}
