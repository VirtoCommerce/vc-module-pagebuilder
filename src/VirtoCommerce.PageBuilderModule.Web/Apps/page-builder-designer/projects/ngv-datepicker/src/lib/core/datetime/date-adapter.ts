...
export abstract class DateAdapter<D> {
  ...
  */
   ...
   * method on all of its signal inputs that accept dates. It is therefore possible to
   * support passing values from your backend directly to these inputs by overriding this method
