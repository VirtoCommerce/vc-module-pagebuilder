...
export const loadPresets = createAction('[Theme] Load Presets');
export const loadPresetsSuccess = createAction('[Theme] Load Presets Success', props<{ presets: PresetsModel, basePresets: PresetsModel }>());
export const loadPresetsFail = createAction('[Theme] Load Presets Fail', props<{ error: HttpErrorResponse }>());

export const saveTheme = createAction('[Theme] Save Theme');
export const saveThemeSuccess = createAction('[Theme] Save Theme Success', props<{ values: { [key: string]: ValueType } }>());
