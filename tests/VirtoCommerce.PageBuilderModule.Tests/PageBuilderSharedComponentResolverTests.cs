...
public class PageBuilderSharedComponentResolverTests
{
    [Fact]
        ...
        : IPageBuilderSharedComponentContentService
    {
        ...
        {
            contents.TryGetValue(sharedComponentId, out var content);
        ...
        public Task<IReadOnlyDictionary<string, string>> LoadContentsAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            IReadOnlyDictionary<string, string> result = sharedComponentIds
